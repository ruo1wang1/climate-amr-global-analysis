...
write_result_tables <- function(
  ...
  metadata_df <- tibble(
    ...
    value = c(
      ...
      "Global scaling across each bacteria-specific model-ready dataset",
      ...
      "Recursive stochasticity calibrated from historical observed-versus-fitted residual series using bacterium-specific AR(1)-style persistence and innovation SD estimates, combined across global and climate-zone annual fits",
      ...
      "TRUE; bacterium-specific residual calibration exported to projection_recursive_uncertainty_calibration.csv",
