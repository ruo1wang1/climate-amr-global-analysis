...
write_classify_rob_method <- function(out_path) {
  method_lines <- c(
  ...
  writeLines(method_lines, out_path)
}
...
write_classify_rob_method(file.path(dirs$robust, "classify_rob_method.md"))
...
cat("\nROBUSTNESS METHOD NOTE:\n")
cat("  See classify_rob_method.md for explicit rule-based criteria.\n")
