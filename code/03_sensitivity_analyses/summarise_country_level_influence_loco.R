...
writeLines(results_text, file.path(dirs$report, "Sensitivity_Results_ModelC_LOCO.txt"))
...
writeLines(methods_text, file.path(dirs$report, "Methods_ModelC_LOCO.txt"))
